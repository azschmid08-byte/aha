...
enum Difficulty: String, CaseIterable, Identifiable {
    ...
    var pieceCount: Int { self == .easy ? 9 : self == .medium ? 16 : 25 }
}
...
struct UIKitPuzzleGridView: UIViewRepresentable {
    ...
    static func dismantleUIView(_ uiView: PuzzleGridView3, coordinator: ()) {
        uiView.onSolved = nil
    }
}


class PuzzleGridView3: UIView {
